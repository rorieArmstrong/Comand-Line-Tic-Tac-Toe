...
class Board:
    ...
    def lost(self):
        return (((self.board[0] != ' ' and
                ...
                or (self.board[22] != ' ' and
                    ((self.board[19] == self.board[22] == self.board[25]) or
                    (self.board[21] == self.board[22] == self.board[23]) or
                    (self.board[20] == self.board[22] == self.board[24])))
